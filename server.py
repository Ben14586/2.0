...
class Handler(SimpleHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if path == "/api/orders":
            ...
            customer_note = clamp_text(body.get("customerNote"), 600)
...
if __name__ == "__main__":
    ...
    if BOOTSTRAP_PASSWORD_NOTICE:
        print(BOOTSTRAP_PASSWORD_NOTICE)
    if not ADMIN_KEY:
        print("ADMIN_KEY is not set; master key login is disabled and admin login uses database sessions only.")
